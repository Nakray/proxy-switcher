...
Сервис управления прокси через тг-бота. Служба принимает входящие соединения SOCKS5 и маршрутизирует трафик через лучший доступный upstream-прокси на основе проверок. 

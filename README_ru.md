...
1. **Файрвол**: Откройте только нужные порты (1080, 2080, 9090)
2. **TLS**: Используйте reverse proxy с TLS
3. **Аутентификация**: Включите SOCKS5 аутентификацию
4. **Секреты**: Не коммитьте секреты в git
5. **Обновления**: Регулярно обновляйте сервис
...
Contributions приветствуются! Создавайте Pull Request.
